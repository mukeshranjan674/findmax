...
public class FindMaximumTest {
	...
	public void givenAllThreeDataTypesShouldReturnMaximum() {
		...
		Float[] floatArray = { 40.12f, 20.05f, 300.80f };
		Integer[] integerArray = { 10, 5, 60 };
		FindMaximum<Integer, Float, String> findMaximum = new FindMaximum<Integer, Float, String>(integerArray,
	...
	@Test
	public void givenMoreStringArgs_ShouldReturnMax() {
		FindMaximum<Integer, Float, String> findMaximum = new FindMaximum<Integer, Float, String>(null, null, null);
		String max = findMaximum.findMaximum("Apple", "Banana", "Peach", "Guava", "Pears");
		assertEquals("Pears", max);
	}
}
